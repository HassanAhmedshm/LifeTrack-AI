...
import { House, Zap, Target, MessageCircle, LayoutGrid } from "lucide-react-native";
      ...
      >
        ...
        <Tabs.Screen
          ...
          options={{
            title: "Hub",
            tabBarIcon: ({ color }) => (
              <TabBarIcon name="hub" color={color} />
            ),
          }}
        />
      </Tabs>
